...
import {ArrowLeft, Calendar, Clock, HashIcon} from "lucide-react";
            ...
            <article className="min-w-0">
              ...
              {post.banner && (
                  <motion.div
                      ...
                      className="relative aspect-[16/9] rounded-2xl overflow-hidden mb-16 shadow-sm border border-border/50"
                  >
                    <Image
